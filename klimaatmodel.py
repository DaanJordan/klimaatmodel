...
beta2 = st.number_input("1-β2: Innovatie en populatie parameter", value=0.52, step=0.01, format="%.2f", key="beta2")
g = st.number_input("g: groeifactor", value=0.015, step=0.0288, format="%.3f", key="g")
k = st.number_input("K: klimaatrespons op emissies", value=0.346, step=0.01, format="%.2f", key="k")
